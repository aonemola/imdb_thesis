view: decade_bands {
  derived_table: {
     sql: SELECT
          (EXTRACT(YEAR FROM movies.release_date_date )) AS movies_release_date_year,
          CASE
       WHEN (movies.release_date_date  < (DATE('1900-01-01'))) THEN 'Before 1900s'
        WHEN (((movies.release_date_date ) >= (DATE('1900-01-01')) AND (movies.release_date_date ) < (DATE('1910-01-01')))) THEN '1900s'
        WHEN (((movies.release_date_date ) >= (DATE('1910-01-01')) AND (movies.release_date_date ) < (DATE('1920-01-01')))) THEN '1910s'
        WHEN (((movies.release_date_date ) >= (DATE('1920-01-01')) AND (movies.release_date_date ) < (DATE('1930-01-01')))) THEN '1920s'
        WHEN (((movies.release_date_date ) >= (DATE('1930-01-01')) AND (movies.release_date_date ) < (DATE('1940-01-01')))) THEN '1930s'
        WHEN (((movies.release_date_date ) >= (DATE('1940-01-01')) AND (movies.release_date_date ) < (DATE('1950-01-01')))) THEN '1940s'
        WHEN (((movies.release_date_date ) >= (DATE('1950-01-01')) AND (movies.release_date_date ) < (DATE('1960-01-01')))) THEN '1950s'
        WHEN (((movies.release_date_date ) >= (DATE('1960-01-01')) AND (movies.release_date_date ) < (DATE('1970-12-31')))) THEN '1960s'
        WHEN (((movies.release_date_date ) >= (DATE('1970-01-01')) AND (movies.release_date_date ) < (DATE('1980-01-01')))) THEN '1970s'
        WHEN (((movies.release_date_date ) >= (DATE('1980-01-01')) AND (movies.release_date_date ) < (DATE('1990-01-01')))) THEN '1980s'
        WHEN (((movies.release_date_date ) >= (DATE('1990-01-01')) AND (movies.release_date_date ) < (DATE('2000-01-01')))) THEN '1990s'
        WHEN (((movies.release_date_date ) >= (DATE('2000-01-01')) AND (movies.release_date_date ) < (DATE('2010-01-01')))) THEN '2000s'
        WHEN (((movies.release_date_date ) >= (DATE('2010-01-01')) AND (movies.release_date_date ) < (DATE('2020-01-01')))) THEN '2010s'
  ...
  dimension: movies_release_date_year {
    type: number
    sql: ${TABLE}.movies_release_date_year ;;
  }
  ...
  set: detail {
    fields: [movies_release_date_year, decade_bands, popular_genre_groups, movies_title]
  }
}
